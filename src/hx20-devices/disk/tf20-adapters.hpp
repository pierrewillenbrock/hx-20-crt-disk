...
public:
    ...
    //0x11
    virtual uint8_t file_find_first(uint8_t us, uint8_t const *pattern, uint8_t extent, void *dir_entry, std::string &filename) =0;
    //0x12
    virtual uint8_t file_find_next(void *dir_entry, std::string &filename) =0;
    //0x13
    virtual uint8_t file_remove(uint8_t us, uint8_t const *filename, uint8_t extent) =0;
    //0x16
